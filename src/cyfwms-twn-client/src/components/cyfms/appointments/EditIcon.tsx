import { doRemove, doSearch } from "../../../features/cyfms/appointment/slice";
...
const EditIcon: FC<any> = ({
  ...
  // console.log(state.participantId)
  const handleDelete = () => {
    console.log(state.participantId);
    dispatch(doRemove(participantAppointmentId))
      .then(() => setOpenModel(false))
      .then(() => dispatch(doSearch(targetValue || null)));

    setAddNew(false);
    console.log("api succesfully");
  };
