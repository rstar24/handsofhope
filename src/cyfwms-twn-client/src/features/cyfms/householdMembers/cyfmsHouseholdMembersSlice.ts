...
>({
  ...
  reducers: {
    ...
    removeHouseholdMembersRecordNumber(state, action) {
      state.householdMembersData.recordsList.splice(action.payload - 1, 1);
    },
  },
...
export const {
  ...
  cleanHouseholdMembersState,
  removeHouseholdMembersRecordNumber,
