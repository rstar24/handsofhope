...
export const cgSearchSlice = createSlice<State, SliceCaseReducers<State>>({
  name: "cgSearch",
  initialState: {
    data: [],
    status: "none",
...
export const { spliceRecord, cleanState } = cgSearchSlice.actions;

export default cgSearchSlice.reducer;
