        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: "1rem 0" }}>
          <Box>
            ...
            >
              ...
              >
                ...
                <Box sx={{ flexBasis: 0, flexGrow: 0.5 }}>
                  <Input autofill={data.name} id="naam" value="Name" />
                </Box>
              </Box>
            </Box>
          </Box>
          <Box>
            ...
            >
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: "0 1rem" }}>
                <Box sx={{ flexBasis: 0, flexGrow: 1 }}>
                  <Input autofill={data.address} id="address" value="Address" />
                </Box>
                <Box sx={{ flexBasis: 0, flexGrow: 1 }}>
                  <Input autofill={data.phone} id="phone" value="Phone" />
                </Box>
              </Box>
              <Box
                sx={{
              ...
              >
                <Box sx={{ flexBasis: 0, flexGrow: 1 }}>
                  <Input autofill={data.email} id="eMail" value="Email" />
                </Box>
