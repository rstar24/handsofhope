...
import { doGet as doGetCalendar, doGetByDate, setCalendarView } from "../../features/calendar/reminders/slice";
          ...
          >
            <TableCell sx={{ color: "black" }} align="center" size="small">
              ...
              { val.fileDetailsId && (
                ...
                onClick={() =>{ handleSelected(val.reminderId, val.fileDetailsId);
              ...
              { val.cgProviderId && (
                <Link
                to="../initial_contact/reminders"
                onClick={() =>{ handleSelected(val.reminderId, val.cgProviderId);
                  dispatch(doSearchICAppointment({ id:val.cgProviderId, data: "" }))
                }}
              >
                Select
              </Link>
