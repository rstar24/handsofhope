...
import { Data, doPost } from "../../../features/cpa/participant/slice";
  ...
  const submitHandler = (e: FormEvent) => {
    ...
    if (!click) {
      ...
      dispatch(doPost(formData))
        .unwrap()
        .then(() => {
          console.log("CpaParticipants POST backend API was successful!");
          setAddNew(false);
        })
        .catch((err: any) => {
          console.log("CpaParticipants POST backend API didn't work!");
          console.log(err);
        });
    }
  };
