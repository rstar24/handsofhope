...
public class ParticipantControllerTest {
	...
	public void readParticipantIdentityTest() throws Exception {
		ParticipantIdentityDto participantIdentityDto = ParticipantIdentityDto
			.builder()
			.firstname("raj")
			.middleName("verma")
			.gender("male")
			...
			.participantImageType("json")
			.build();

		Mockito
			.when(participantService.readParticipantIdentity(anyLong()))
			.thenReturn(participantIdentityDto);

		mockMvc
			.perform(
				MockMvcRequestBuilders.get("/v1/participantservice/readParticipantIdentity/1")
			)
			.andDo(print())
	...
	public void saveParticipantIdentityTest() throws Exception {
		...
		img =
			ImageIO.read(
				new File("C:\\Users\\rajeev\\Pictures\\Screenshots\\Screenshot12.jpg")
			);
		...
		MockMultipartFile image = new MockMultipartFile(
			...
			"",
			"application/json",
			"{\"image\": \"C:\\Users\\rajeev\\Pictures\\Screenshots\\Screenshot12.jpg\"}".getBytes()
		);

		when(participantService.saveParticipantIdentity(participantIdentityDto, image))
			.thenReturn(participantIdentityDto);

		mockMvc
			.perform(
				multipart("/v1/participantservice/saveParticipantIdentity")
					.file(image)
					.param("image", "test-title")
	...
	public void removeParticipantTest() throws Exception {
		...
		mockMvc.perform(delete("/v1/participantservice/removeParticipant/9")).andDo(print());
	}

	@Test
	public void readParticipantContactTest() throws Exception {
		ParticipantContactDto participantContactDto = ParticipantContactDto
			.builder()
			.participantId(1L)
			.participantContactId(2L)
			.addressLine1("vijaynagar")
			.addressLine2("vijaynagar")
			.city("indore")
		...
		Mockito
			.when(participantContactService.readParticipantContact(anyLong()))
			.thenReturn(participantContactDto);

		mockMvc
			.perform(get("/v1/participantservice/readParticipantContact/1"))
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
	...
	public void saveParticipantContactTest() throws Exception {
		...
		Mockito
			.when(
				participantContactService.saveParticipantContact(any(ParticipantContactDto.class))
			)
			.thenReturn(participantContactDto);
		...
		mockMvc
			.perform(
				MockMvcRequestBuilders
					.put("/v1/participantservice/saveParticipantContact")
			...
			.andExpect(MockMvcResultMatchers.jsonPath("$.addressLine1", is("rau")))
			.andExpect(MockMvcResultMatchers.jsonPath("$.addressLine2", is("rau")))
			.andExpect(MockMvcResultMatchers.jsonPath("$.city", is("indore")))
			.andExpect(MockMvcResultMatchers.jsonPath("$.province", is("no")))
			.andExpect(MockMvcResultMatchers.jsonPath("$.postalCode", is("123")))
			.andExpect(MockMvcResultMatchers.jsonPath("$.homePhone", is("12345")))
			.andExpect(MockMvcResultMatchers.jsonPath("$.workPhone", is("12345")))
			.andExpect(MockMvcResultMatchers.jsonPath("$.cellPhone", is("12345")))
			.andExpect(MockMvcResultMatchers.jsonPath("$.emailAddress", is("yash@gmail.com")));
	}
	...
	public void getAllHouseholdMembersTest() throws Exception {
		...
		hmDtoList.add(
			HouseholdMemberDto
				.builder()
				.householdMemberId(2L)
				.participantId(4L)
				.dateOfBirth(LocalDate.of(2021, 05, 12))
		...
		mockMvc
			.perform(get("/v1/participantservice/getAllHouseholdMembers/1"))
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(jsonPath("$.size()", is(hmDtoList.size())));
	}
	...
	public void saveHouseholdMembersTest() throws Exception {
		...
		mockMvc
			.perform(
				put("/v1/participantservice/saveAllHouseholdMembers")
	...
	public void removeHouseholdMembers() throws Exception {
		...
		willDoNothing()
			.given(householdMemberService)
			.removeHouseholdMembers(householdMemberId);

		ResultActions response = mockMvc.perform(
			delete(
				"/v1/participantservice/removeAddMoreHouseholdMember/{householdMemberId}",
				householdMemberId
			)
		);
	...
	public void readCriminalHistoryTest() throws Exception {
		CriminalHistoryDto criminalHistoryDto = CriminalHistoryDto
			.builder()
			.criminalHistoryId(2L)
			.participantId(3L)
			.conditions("true")
			.parole(true)
			.criminalHistoryRecordList(new ArrayList<>())
			.probation(true)
			.courtWorkerAndContactInfo("info")
			.build();

		Mockito
			.when(criminalHistoryService.readCriminalHistory(anyLong()))
			.thenReturn(criminalHistoryDto);

		mockMvc
			.perform(get("/v1/participantservice/readCriminalHistory/3"))
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
			...
			.andExpect(
				MockMvcResultMatchers.jsonPath("$.courtWorkerAndContactInfo").value("info")
			)
			.andExpect(status().isOk());
	}
	...
	public void saveCriminalHistoryTest() throws Exception {
		...
		Mockito
			.when(criminalHistoryService.saveCriminalHistory(any(CriminalHistoryDto.class)))
			.thenReturn(criminalHistoryDto);
		mockMvc
			.perform(
				MockMvcRequestBuilders
					.put("/v1/participantservice/saveCriminalHistory")
	...
	public void removeCriminalHistoryRecord() throws Exception {
		...
		willDoNothing()
			.given(criminalHistoryService)
			.removeCriminalHistoryRecord(criminalHistoryRecordId);

		ResultActions response = mockMvc.perform(
			delete(
				"/v1/participantservice/removeAddMoreCriminalHistory/{criminalhistoryrecordid}",
	...
	public void getAllFamilyPhysiciansTest() throws Exception {
		...
		familyPhysicianDtoList.add(
			FamilyPhysicianDto
				.builder()
				.participantId(5L)
				.familyPhysicianId(2L)
				.name("ankit")
				.phone("123")
				.listOfMedication("no list")
				.cell("12345")
				.build()
		);

		given(familyPhysicianService.getAllFamilyPhysicians(any()))
			.willReturn(familyPhysicianDtoList);

		mockMvc
			.perform(
				MockMvcRequestBuilders.get("/v1/participantservice/getAllFamilyPhysicians/5")
			)
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(jsonPath("$.size()", is(familyPhysicianDtoList.size())));
	}
	...
	public void saveAllFamilyPhysicianTest() throws Exception {
		...
		given(familyPhysicianService.saveAllFamilyPhysicians(any()))
			.willReturn(familyPhysicianDtoList);

		mockMvc
			.perform(
				put("/v1/participantservice/saveAllFamilyPhysicians")
	...
	public void removeFamilyPhysicianTest() throws Exception {
		...
		willDoNothing()
			.given(familyPhysicianService)
			.removeFamilyPhysician(familyPhysicianId);

		ResultActions response = mockMvc.perform(
			delete(
				"/v1/participantservice/removeAddMoreFamilyPhysician/{familyPhysicianId}",
				familyPhysicianId
			)
		);
	...
	public void getAllCounselorCFSWorkersTest() throws Exception {
		...
		counselorCFSWorkersDtoList.add(
			CounselorCFSWorkersDto
				.builder()
				.participantId(5L)
				.counselorCFSWorkerId(2L)
				.name("ankit")
				.role("employee")
				.contactInformation("info")
				.startDate(LocalDate.of(2021, 01, 02))
				.endDate(LocalDate.of(2022, 01, 02))
				.build()
		);

		given(counselorCFSWorkerService.getAllCounselorCFSWorkers(any()))
			.willReturn(counselorCFSWorkersDtoList);

		mockMvc
			.perform(
				MockMvcRequestBuilders.get("/v1/participantservice/getAllCounselorCFSWorkers/6")
			)
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(jsonPath("$.size()", is(counselorCFSWorkersDtoList.size())));
	}
	...
	public void saveAllCounselorCFSWorkersTest() throws Exception {
		...
		given(counselorCFSWorkerService.saveAllCounselorCFSWorkers(any()))
			.willReturn(counselorCFSWorkersDtoList);

		mockMvc
			.perform(
				MockMvcRequestBuilders
					.put("/v1/participantservice/saveAllCounselorCFSWorkers")
	...
	public void removeAddMoreCounselorCFSWorkerTest() throws Exception {
		...
		willDoNothing()
			.given(counselorCFSWorkerService)
			.removeCounselorCFSWorker(counselorCFSWorkerId);

		ResultActions response = mockMvc.perform(
			delete(
				"/v1/participantservice/removeAddMoreCounselorCFSWorker/{counselorcfsworkerid}",
	...
	public void readParticipantOtherInformationTest() throws Exception {
		ParticipantOtherInformationServiceDto participantOtherInformationServiceDto = ParticipantOtherInformationServiceDto
			.builder()
			.participantId(1l)
		...
		Mockito
			.when(participantOtherInformationService.readParticipantOtherInformation(1l))
			.thenReturn(participantOtherInformationServiceDto);

		mockMvc
			.perform(get("/v1/participantservice/readParticipantOtherInformation/1"))
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
	...
	public void saveParticipantOtherInformationTest() throws Exception {
		...
		Mockito
			.when(
				participantOtherInformationService.saveParticipantOtherInformation(
					any(ParticipantOtherInformationServiceDto.class)
				)
			)
			.thenReturn(participantOtherInformationServiceDto);
		...
		mockMvc
			.perform(
				MockMvcRequestBuilders
					.put("/v1/participantservice/saveParticipantOtherInformation")
	...
	public void readEmploymentAndEducationTest() throws Exception {
		EducationAndEmploymentCompositeDto educationAndEmploymentCompositeDto = EducationAndEmploymentCompositeDto
			.builder()
			.educationId(1L)
			.employmentId(2L)
			.participantId(3L)
			.desiredProfession("professional")
			.employed("yes")
			.grade("A")
			.typeOfEmployment("student")
			.school("wishwood")
			.attendingSchool("little angles")
			.build();

		Mockito
			.when(educationAndEmploymentService.readEducationAndEmployment(anyLong()))
			.thenReturn(educationAndEmploymentCompositeDto);

		mockMvc
			.perform(get("/v1/participantservice/readEmploymentAndEducation/3"))
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
			...
			.andExpect(
				MockMvcResultMatchers.jsonPath("$.attendingSchool", is("little angles"))
			);
	}
	...
	public void saveEmploymentAndEducationTest() throws Exception {
		...
		Mockito
			.when(
				educationAndEmploymentService.saveEducationAndEmployment(
					any(EducationAndEmploymentCompositeDto.class)
				)
			)
			.thenReturn(educationAndEmploymentCompositeDto);
		...
		mockMvc
			.perform(
				put("/v1/participantservice/saveEmploymentAndEducation")
			...
			.andExpect(
				MockMvcResultMatchers.jsonPath("$.desiredProfession", is("professional"))
			)
	...
	public void searchParticipantsTest() throws Exception {
		...
		participantSearchCriteriaDto.add(
			ParticipantSearchResultsDto
				.builder()
				.referenceId(1L)
				.firstname("sonu")
				.surname("dwivedi")
				...
				.city("indore")
				.cellPhone("12345")
				.dateOfBirth(LocalDate.ofEpochDay(10 / 12 / 1994))
		...
		participantSearchCriteriaDto.add(
			ParticipantSearchResultsDto
				...
				.city("mhow")
				.cellPhone("12345789")
				.dateOfBirth(LocalDate.ofEpochDay(11 / 11 / 1995))
				.maritalStatus("married")
				.build()
		);

		Mockito
			.when(participantSearchService.search(any()))
			.thenReturn(participantSearchCriteriaDto);
		mockMvc
			.perform(
				get(
						"/v1/participantservice/searchParticipants/1/null/null/null/null/null/null/null"
					)
			...
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(jsonPath("$.size()", is(participantSearchCriteriaDto.size())));
	}

	@Test
	public void readAllOutPutParticipantTest() throws Exception {
		ParticipantCommonDataDto participantCommonDataDto = ParticipantCommonDataDto
			.builder()
			.participantId(1L)
			.firstname("shubh")
			.gender("male")
			.counselorCFSWorker(new ArrayList<>())
			.build();

		Mockito
			.when(participantCommonDataService.readParticipantCommonData(any()))
			.thenReturn(participantCommonDataDto);

		mockMvc
			.perform(
				get("/v1/participantservice/readAllOutputParticipant/4")
