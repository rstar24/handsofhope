...
public class TWNInitialContactControllerTest {
	...
	public void readAllFileDetailsTest() throws Exception {
		ICFileDetailsDto icFileDetailsDto = ICFileDetailsDto
			.builder()
			.fileDetailsId(1L)
			.clientName("rajat")
			.caseworker("no")
		...
		Mockito
			.when(iCFileDetailsService.readAllFileDetails(any()))
			.thenReturn(icFileDetailsDto);

		mockMvc
			.perform(
				MockMvcRequestBuilders.get("/v1/initialcontactservice/readAllFileDetails/1")
			)
			.andDo(print())
	...
	public void saveAllFileDetailsTest() throws Exception {
		...
		Mockito
			.when(iCFileDetailsService.saveAllFileDetails(any(ICFileDetailsDto.class)))
			.thenReturn(icFileDetailsDto);

		mockMvc
			.perform(
				MockMvcRequestBuilders
					.put("/v1/initialcontactservice/saveAllFileDetails")
			...
			.andExpect(
				MockMvcResultMatchers.jsonPath(
					"$.startingDate",
					is(LocalDate.of(2021, 04, 01).toString())
				)
			)
			.andExpect(
				MockMvcResultMatchers.jsonPath(
					"$.dateClosed",
					is(LocalDate.of(2021, 05, 01).toString())
				)
			)
			.andExpect(MockMvcResultMatchers.jsonPath("$.status", is("Active")));

		Mockito
			.verify(iCFileDetailsService)
			.saveAllFileDetails(Mockito.any(ICFileDetailsDto.class));
	}

	@Test
	public void readAllIncidentReportsTest() throws Exception {
		ICIncidentReportDto icIncidentReportDto = ICIncidentReportDto
			.builder()
			.fileDetailsId(1L)
			.incidentReportId(2L)
			.reportedBy("rajat")
		...
		Mockito
			.when(iCIncidentReportService.readAllIncidentReports(any()))
			.thenReturn(icIncidentReportDto);

		mockMvc
			.perform(
				MockMvcRequestBuilders.get("/v1/initialcontactservice/readAllIncidentReports/1")
			)
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
			.andExpect(MockMvcResultMatchers.jsonPath("$.fileDetailsId").exists())
	...
	public void saveAllIncidentReportsTest() throws Exception {
		...
		Mockito
			.when(
				iCIncidentReportService.saveAllIncidentReports(any(ICIncidentReportDto.class))
			)
			.thenReturn(icIncidentReportDto);

		mockMvc
			.perform(
				put("/v1/initialcontactservice/saveAllIncidentReports")
	...
	public void readAllPatientCareInfoTest() throws Exception {
		ICPatientCareInfoDto icPatientCareInfoDto = ICPatientCareInfoDto
			.builder()
		...
		Mockito
			.when(iCPatientCareInfoService.readAllPatientCareInfo(any()))
			.thenReturn(icPatientCareInfoDto);

		mockMvc
			.perform(get("/v1/initialcontactservice/readAllPatientCareInfo/2"))
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
			.andExpect(MockMvcResultMatchers.jsonPath("$.fileDetailsId").exists())
	...
	public void saveAllPatientCareInfoTest() throws Exception {
		...
		Mockito
			.when(
				iCPatientCareInfoService.saveAllPatientCareInfo(any(ICPatientCareInfoDto.class))
			)
			.thenReturn(icPatientCareInfoDto);

		mockMvc
			.perform(
				put("/v1/initialcontactservice/saveAllPatientCareInfo")
	...
	public void readPresentConcernsTest() throws Exception {
		ICPresentConcernsDto icPresentConcernsDto = ICPresentConcernsDto
			.builder()
			.fileDetailsId(1L)
		...
		Mockito
			.when(iCPresentConcernsService.readPresentConcerns(any()))
			.thenReturn(icPresentConcernsDto);

		mockMvc
			.perform(get("/v1/initialcontactservice/readAllPresentConcerns/1"))
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
			.andExpect(MockMvcResultMatchers.jsonPath("$.fileDetailsId").exists())
	...
	public void savePresentConcernsTest() throws Exception {
		...
		Mockito
			.when(iCPresentConcernsService.savePresentConcerns(any()))
			.thenReturn(icPresentConcernsDto);

		mockMvc
			.perform(
				put("/v1/initialcontactservice/saveAllPresentConcerns")
	...
	public void readAllReferralInfoTest() throws Exception {
		ICReferralInfoDto icReferralInfoDto = ICReferralInfoDto
			.builder()
			.fileDetailsId(1L)
			.referralInfoId(2L)
			.address("nosituation")
		...
		Mockito
			.when(iCReferralInfoService.readAllReferralInfo(any()))
			.thenReturn(icReferralInfoDto);

		mockMvc
			.perform(get("/v1/initialcontactservice/readAllReferralInfo/1"))
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
			.andExpect(MockMvcResultMatchers.jsonPath("$.fileDetailsId").exists())
	...
	public void saveAllReferralInfoTest() throws Exception {
		...
		Mockito
			.when(iCReferralInfoService.saveAllReferralInfo(any()))
			.thenReturn(icReferralInfoDto);

		mockMvc
			.perform(
				put("/v1/initialcontactservice/saveAllReferralInfo")
	...
	public void readContactNotesTest() throws Exception {
		ICContactNotesDto icContactNotesDto = ICContactNotesDto
			.builder()
			.fileDetailsId(1L)
			.contactNotesId(2L)
			.name("nosituation")
		...
		Mockito
			.when(iCContactNotesService.readContactNotes(any()))
			.thenReturn(icContactNotesDto);

		mockMvc
			.perform(get("/v1/initialcontactservice/readAllContactNotes/1"))
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
			.andExpect(MockMvcResultMatchers.jsonPath("$.fileDetailsId").exists())
			...
			.andExpect(
				MockMvcResultMatchers.jsonPath("$.additionalInformation").value("infotect")
			)
	...
	public void saveContactNotesTest() throws Exception {
		...
		Mockito
			.when(iCContactNotesService.saveContactNotes(any(ICContactNotesDto.class)))
			.thenReturn(icContactNotesDto);

		mockMvc
			.perform(
				put("/v1/initialcontactservice/saveAllContactNotes")
	...
	public void searchICContactNotesTest() throws Exception {
		...
		icContactNotesSearchResultsDtoList.add(
			ICContactNotesSearchResultsDto
				.builder()
				.fileDetailsId(1L)
				.name("sonu")
				.additionalInformation("visa")
				.casePlanProgress("progress")
				.needAddress("indore")
				.worker("work")
				.date(LocalDate.ofEpochDay(10 / 12 / 1994))
				.result("negative")
				.build()
		);
		icContactNotesSearchResultsDtoList.add(
		...
		Mockito
			.when(iCContactNotesSearchService.search(any()))
			.thenReturn(icContactNotesSearchResultsDtoList);
		mockMvc
			.perform(
				get("/v1/initialcontactservice/searchContactNotes/1/indore")
					.content(objectMapper.writeValueAsString(icContactNotesSearchResultsDtoList))
					.contentType(MediaType.APPLICATION_JSON)
			)
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(jsonPath("$.size()", is(icContactNotesSearchResultsDtoList.size())));
	}
	...
	public void removeContactNotesTest() throws Exception {
		...
		ResultActions response = mockMvc.perform(
			delete("/v1/initialcontactservice/removeContactNotes/1", contactNotesId)
		);
	...
	public void searchInitialContactsTest() throws Exception {
		...
		mockMvc
			.perform(
				get("/v1/initialcontactservice/search/harsh/null/null/null/null")
					.content(objectMapper.writeValueAsString(icSearchResultsDtoList))
					.contentType(MediaType.APPLICATION_JSON)
			)
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(jsonPath("$.size()", is(icSearchResultsDtoList.size())));
	}
	...
	public void removeICFileDetailsTest() throws Exception {
		...
		ResultActions response = mockMvc.perform(
			delete("/v1/initialcontactservice/remove/{fileNumber}", fileNumber)
		);
	...
	public void iCCommonDataTest() throws Exception {
		ICCommonDataDto icCommonDataDto = ICCommonDataDto
			.builder()
			.fileDetailsId(1L)
			.fileNumber(2L)
			.participantId(3L)
		...
		mockMvc
			.perform(get("/v1/initialcontactservice/readAll/2"))
			.andDo(print())
			.andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
			.andExpect(MockMvcResultMatchers.jsonPath("$.fileDetailsId").exists())
			.andExpect(MockMvcResultMatchers.jsonPath("$.fileNumber").value(2))
			...
			.andExpect(
				MockMvcResultMatchers
					.jsonPath("$.startingDate")
					.value(LocalDate.of(2021, 05, 06).toString())
			)
			.andExpect(
				MockMvcResultMatchers
					.jsonPath("$.dateClosed")
					.value(LocalDate.of(2021, 06, 07).toString())
			)
