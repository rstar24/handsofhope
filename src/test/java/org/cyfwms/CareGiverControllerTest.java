...
public class CareGiverControllerTest {
	...
	public void readCareProviderTest() throws Exception {
		CareProviderDto careProviderDto = CareProviderDto
			.builder()
			.Id(3L)
			.name("anuj")
			.status("ACTIVE")
			...
			.primaryCaregiver("rajat")
			.secondaryCaregiver("noone")
			.referenceId(1L)
			.build();
		...
		mockMvc
			.perform(
				get("/v1/caregiverservice/care_provider/read/3")
	...
	public void saveCareProviderTest() throws Exception {
		...
		mockMvc
			.perform(
				put("/v1/caregiverservice/care_provider/save")
					.content(objectMapper.writeValueAsString(careProviderDto))
					.contentType(MediaType.APPLICATION_JSON)
			)
			.andDo(print())
	...
	public void removeCareProviderTest() throws Exception {
		...
		mockMvc
			.perform(delete("/v1/caregiverservice/care_provider/remove/3"))
			.andExpect(status().isOk())
			.andDo(print());
	}
	...
	public void searchCareGiverTest() throws Exception {
		...
		careProviderSearchResultsDtoList.add(
			CareProviderSearchResultsDto
				.builder()
				.cgProviderId(1L)
				.name("shubham")
				.type("employee")
		...
		Mockito
			.when(careProviderSearchService.searchCareGiver(any()))
			.thenReturn(careProviderSearchResultsDtoList);
		mockMvc
			.perform(
				get("/v1/caregiverservice/careGiverProviderSearch/5/null/null/null/null/null/")
			)
			.andExpect(status().isOk())
			.andDo(print())
			.andExpect(
				MockMvcResultMatchers.jsonPath(
					"$.size()",
					is(careProviderSearchResultsDtoList.size())
				)
			);
	}
	...
	public void readCapacityTest() throws Exception {
		CapacityDto capacityDto = CapacityDto
			.builder()
			.cgCapacityId(2L)
			.cgProviderId(3L)
			.currUtil(4L)
		...
		mockMvc
			.perform(get("/v1/caregiverservice/readCapacity/3"))
			.andDo(print())
	...
	public void saveCapacityTest() throws Exception {
		CapacityDto capacityDto = CapacityDto
			...
			.build();
		Mockito
			.when(capacityService.saveCapacity(any(CapacityDto.class)))
			.thenReturn(capacityDto);

		mockMvc
			.perform(
				put("/v1/caregiverservice/saveCapacity")
	...
	public void getAllContactNotesTest() throws Exception {
		ContactNotesDto contactNotesDto = ContactNotesDto
			.builder()
			.cgContactNotesId(1L)
			.contactMethod("nomethod")
			.time(LocalTime.of(02, 45, 56))
			.date(LocalDate.of(2021, 02, 03))
			.additionalInformation("noinfo")
			.cgProviderId(4L)
			.needAddress("yes")
			.summary("sum")
			.build();
		...
		Mockito
			.when(contactNotesService.getAllContactNotes(any()))
			.thenReturn(contactNotesDto);
		mockMvc
			.perform(get("/v1/caregiverservice/getAllContactNotes/4"))
			.andExpect(status().isOk())
			.andDo(print());
	}
	...
	public void saveAllContactNotesTest() throws Exception {
		...
		Mockito
			.when(contactNotesService.saveAllContactNotes(any()))
			.thenReturn(contactNotesDto);
		mockMvc
			.perform(
				put("/v1/caregiverservice/saveAllContactNotes")
	...
	public void removeContactNotesTest() throws Exception {
		...
		mockMvc
			.perform(delete("/v1/caregiverservice/removeContactNotes/3"))
			.andExpect(status().isOk())
			.andDo(print());
	}
	...
	public void searchCareGiverContactNotesTest() throws Exception {
		...
		careGiverContactNotesSearchResultsDtoList.add(
			CareGiverContactNotesSearchResultsDto
				.builder()
				.cgProviderId(1L)
				.cgContactNotesId(4L)
				.name("manish")
				.contactMethod("save")
				.date(LocalDate.of(2021, 02, 01))
				.needAddress("indore")
				.build()
		);

		when(careGiverContactNotesSearchService.searchContactNotes(any()))
			.thenReturn(careGiverContactNotesSearchResultsDtoList);

		mockMvc
			.perform(get("/v1/caregiverservice/searchContactNotes/1/indore"))
			.andExpect(status().isOk())
			.andDo(print());
	}
	...
	public void readCareGiversBackGroundCheckTest() throws Exception {
		CareGiversBackGroundCheckDto careGiversBackGroundCheckDto = CareGiversBackGroundCheckDto
			.builder()
			.cgBackGroundCheckId(2L)
			.cgProviderId(4L)
			.priBGCheckStatus("ACTIVE")
			.secBGCheckStatus("NOACTIVE")
			.secTrainingCompleted("yes")
			.build();

		when(cgBackGroundCheckService.readCareGiversBackGroundCheck(any()))
			.thenReturn(careGiversBackGroundCheckDto);

		mockMvc
			.perform(get("/v1/caregiverservice/readCareGiversBackGroundCheck/4"))
			.andExpect(status().isOk())
			.andDo(print());
	}
	...
	public void saveCareGiversBackGroundCheckTest() throws Exception {
		...
		when(cgBackGroundCheckService.saveCareGiversBackGroundCheck(any()))
			.thenReturn(careGiversBackGroundCheckDto);

		mockMvc
			.perform(
				put("/v1/caregiverservice/saveCareGiversBackGroundCheck")
