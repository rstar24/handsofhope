...
public class CareGiverController {
	...
	@GetMapping(
		value = {
			"/careGiverProviderSearch/{referenceId}/{name}/{type}/{priCaregiver}/{secCaregiver}/{status}"
		},
	...
	public List<CareProviderSearchResultsDto> searchCareGiver(
		...
		careProviderSearchCriteriaDto.setReferenceId(
		...
		careProviderSearchCriteriaDto.setPriCaregiver(
			("null".equals(var.get("priCaregiver")) || var.get("priCaregiver") == null)
				? null
				: var.get("priCaregiver")
		);

		careProviderSearchCriteriaDto.setSecCaregiver(
			("null".equals(var.get("secCaregiver")) || var.get("secCaregiver") == null)
				? null
				: var.get("secCaregiver")
		);
	...
	@GetMapping(
		value = "/getAllContactNotes/{cgcontactnotesid}",
		produces = "application/json"
	)
	@ApiOperation("Read All ContactNotes")
	@ResponseStatus(HttpStatus.OK)
	public ContactNotesDto getAllContactNotes(
		@PathVariable("cgcontactnotesid") Long cgContactNotesId
	) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ContactNotesDto> saveAllContactNotes(
		@RequestBody ContactNotesDto contactNotesDto
	) {
	...
	@GetMapping(
		value = { "/searchContactNotes/{cgproviderid}/{data}" },
		produces = "application/json"
	)
	...
	public List<CareGiverContactNotesSearchResultsDto> searchCareGiverContactNotes(
		...
		cgContactNotesSearchCriteriaDto.setCgProviderId(
			("null".equals(var.get("cgproviderid")) || var.get("cgproviderid") == null)
				? null
				: Long.parseLong(var.get("cgproviderid"))
		);
		...
		return careGiverContactNotesSearchService.searchContactNotes(
			cgContactNotesSearchCriteriaDto
		);
	}

	@GetMapping(
		value = "/readCareGiversBackGroundCheck/{cgproviderid}",
		produces = "application/json"
	)
	@ApiOperation("Read CareGiversBackGroundCheck")
	public CareGiversBackGroundCheckDto readCareGiversBackGroundCheck(
		@PathVariable("cgproviderid") Long cgProviderId
	) {
	...
	public ResponseEntity<CareGiversBackGroundCheckDto> saveCareGiversBackGroundCheck(
		...
		cgBackGroundCheckDto =
			cgBackGroundCheckService.saveCareGiversBackGroundCheck(cgBackGroundCheckDto);
	...
	public List<CaregiverAppointmentDto> saveCaregiverAppointment(
		...
		log.info(
			"Save or Update caregiver Appointment Informtion :" + caregiverAppointmentDto
		);
	...
	public void removeParticipantAppointment(
		@PathVariable("cgAppointmentId") Long cgAppointmentId
	) {
	...
	@GetMapping(
		value = { "/searchCGAppointment/{id}/{data}" },
		produces = "application/json"
	)
	...
	public List<CaregGiverSearchAppointmentResultDto> searchCGAppointment(
		...
		careGiverSearchAppointmentDto.setId(
			("null".equals(var.get("id")) || var.get("id") == null)
				? null
				: Long.parseLong(var.get("id"))
		);
		careGiverSearchAppointmentDto.setData(
			("null".equals(var.get("data")) || var.get("data") == null) ? null : var.get("data")
		);
		log.info(
			"Search Initial Contact Appointment Information :" + careGiverSearchAppointmentDto
		);
		return careGiverSearchAppointmentService.searchCGAppointment(
			careGiverSearchAppointmentDto
		);
	}

	@GetMapping(
		value = "/readOneAppointment/{CGAppointmentId}",
		produces = "application/json"
	)
	@ApiOperation("Read CareGiver Appointment Information")
	@ResponseStatus(HttpStatus.OK)
	public CaregiverAppointmentDto readOneAppointment(
		@PathVariable("CGAppointmentId") Long CGAppointmentId
	) {
		log.info(
			"Read CareGiver Appointment Information By CGAppointmentId :" + CGAppointmentId
		);
	...
	@ResponseStatus(HttpStatus.OK)
	public List<CareGiverReminderDto> saveCGReminder(
		@RequestBody CareGiverReminderDto careGiverReminderDto
	) {
	...
	@ResponseStatus(HttpStatus.OK)
	public CareGiverReminderDto readCGReminder(
		@PathVariable("cgReminderId") Long cgReminderId
	) {
	...
	@ApiOperation("Remove Contact Notes")
	public ResponseEntity<String> removeCGReminder(
		@PathVariable("cgReminderId") Long cgReminderId
	) {
	...
	@GetMapping(
		value = { "/searchCGReminder/{cgProviderId}/{data}" },
		produces = "application/json"
	)
	...
	public List<CareGiverSearchReminderResultDto> searchCGReminder(
		...
		careGiverSearchReminderDto.setCgProviderId(
			("null".equals(var.get("cgProviderId")) || var.get("cgProviderId") == null)
				? null
				: Long.parseLong(var.get("cgProviderId"))
		);
