...
public class CareGiversBackGroundCheck {
	...
	@Getter
	@Setter
	@Column(name = "primarybgcheckstatus")
	private String priBGCheckStatus;

	@Getter
	@Setter
	@Column(name = "primarydate")
	private LocalDate priDate;

	@Getter
	@Setter
	@Column(length = 1000, name = "primarydetails")
	private String priDetails;

	@Getter
	@Setter
	@Column(length = 1000, name = "primarytrainingcompleted")
	private String priTrainingCompleted;

	@Getter
	@Setter
	@Column(name = "secondarybgcheckstatus")
	private String secBGCheckStatus;

	@Getter
	@Setter
	@Column(name = "secondarydate")
	private LocalDate secDate;

	@Getter
	@Setter
	@Column(length = 1000, name = "secondarydetails")
	private String secDetails;

	@Getter
	@Setter
	@Column(length = 1000, name = "secondarytrainingcompleted")
