...
public class CareProvider {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cGProviderIdGenerator")
	private Long id;

	@Column(name = "reference_id", updatable = false, nullable = false, unique = true)
	...
	@Column(name = "deletion_status", columnDefinition = "VARCHAR(255) DEFAULT 'ACTIVE'")
