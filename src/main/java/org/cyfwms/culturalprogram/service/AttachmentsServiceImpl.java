...
public class AttachmentsServiceImpl implements AttachmentsService {
	...
	private AttachmentEntity readCulturalImage(Long culturalProgramId) {
		AttachmentEntity attachmentEntity = attachmentsRepository
			.findById(culturalProgramId)
				...
				() ->
					new NoSuchElementFoundException(
						messageUtil.getLocalMessage(
							...
							String.valueOf(culturalProgramId)
						)
					)
			);
	...
	@Override
	public AttachmentDTO uploadImage(MultipartFile file, String culturalDto)
		throws IOException {
		Attachment attachment = null;
		AttachmentDTO attachmentDTO = new ObjectMapper()
		.readValue(culturalDto, AttachmentDTO.class);
	...
	public AttachmentDTO getOneFile(Long id) {
		...
		if (attachmentEntity.getAttachment() != null) {
			...
			culturalImageDto.setCulturalimagename(
	...
	public List<AttachmentDTO> getAllFiles(Long culturalProgramId) {
		...
		culturalProgImageDtoList =
			attachmentsRepository
				.findByCulturalProgramId(culturalProgramId)
				.stream()
				.map(
					attachment -> {
						...
						if (attachment.getAttachment() != null) {
							attachDto.setCulturalimagename(
