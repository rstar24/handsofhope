...
public class ParticipantController {
	...
	@GetMapping(
		value = "/readParticipantIdentity/{participantid}",
		produces = "application/json"
	)
	@ApiOperation("Read Identity")
	@ResponseStatus(HttpStatus.OK)
	public ParticipantIdentityDto readParticipantIdentity(
	...
	public ResponseEntity<ParticipantIdentityDto> saveParticipantIdentity(
		...
		participantIdentityDto =
			participantService.saveParticipantIdentity(participantIdentityDto, multipartFile);
	...
	@GetMapping(
		value = "/readParticipantContact/{participantid}",
		produces = "application/json"
	)
	@ApiOperation("Read Contact")
	@ResponseStatus(HttpStatus.OK)
	public ParticipantContactDto readParticipantContact(
		@PathVariable("participantid") Long participantId
	) {
	...
	public ResponseEntity<ParticipantContactDto> saveParticipantContact(
		...
		ParticipantContactDto participantContactDto = participantContactService.saveParticipantContact(
	...
	@GetMapping(
		value = "/getAllHouseholdMembers/{participantid}",
		produces = "application/json"
	)
	...
	@ResponseStatus(HttpStatus.ACCEPTED)
	public ResponseEntity<String> removeHouseholdMembers(
		@PathVariable("householdMemberId") Long householdMemberId
	) {
	...
	@GetMapping(
		value = "/readCriminalHistory/{participantid}",
		produces = "application/json"
	)
	@ApiOperation("Read Criminal History")
	@ResponseStatus(HttpStatus.OK)
	public CriminalHistoryDto readCriminalHistory(
		@PathVariable("participantid") Long participantId
	) {
	...
	@ResponseStatus(HttpStatus.CREATED)
	public CriminalHistoryDto saveCriminalHistory(
		@RequestBody CriminalHistoryDto criminalHistoryDto
	) {
	...
	@ResponseStatus(HttpStatus.ACCEPTED)
	public ResponseEntity criminalHistoryRecord(
		@PathVariable("criminalhistoryrecordid") Long criminalHistoryRecordId
	) {
		log.info(
			"RemoveCriminalHistoryRecords CriminalHistoryRecordId :" + criminalHistoryRecordId
		);
	...
	@GetMapping(
		value = "/getAllFamilyPhysicians/{participantid}",
		produces = "application/json"
	)
	@ApiOperation("Read All Family Physicians")
	@ResponseStatus(HttpStatus.OK)
	public List<FamilyPhysicianDto> getAllFamilyPhysicians(
		@PathVariable("participantid") Long participantId
	) {
	...
	@ResponseStatus(HttpStatus.ACCEPTED)
	public void removeFamilyPhysician(
		@PathVariable("familyPhysicianId") Long familyPhysicianId
	) {
	...
	@GetMapping(
		value = "/getAllCounselorCFSWorkers/{participantid}",
		produces = "application/json"
	)
	@ApiOperation("Read All Counselor CFS Workers")
	@ResponseStatus(HttpStatus.OK)
	public List<CounselorCFSWorkersDto> getAllCounselorCFSWorkers(
		@PathVariable("participantid") Long participantId
	) {
	...
	@ResponseStatus(HttpStatus.ACCEPTED)
	public void removeCounselorCFSWorker(
		@PathVariable("counselorcfsworkerid") Long counselorCFSWorkerId
	) {
	...
	@GetMapping(
		value = "/readParticipantOtherInformation/{participantid}",
		produces = "application/json"
	)
	...
	public ParticipantOtherInformationServiceDto readParticipantOtherInformation(
		...
		return participantOtherInformationService.readParticipantOtherInformation(
			participantId
		);
	}
	...
	public ParticipantOtherInformationServiceDto saveParticipantOtherInformation(
		...
		return participantOtherInformationService.saveParticipantOtherInformation(
			participantOtherInformationServiceDto
		);
	}

	@GetMapping(
		value = "/readEmploymentAndEducation/{participantid}",
		produces = "application/json"
	)
	...
	public EducationAndEmploymentCompositeDto saveEmploymentAndEducation(
		...
		return educationAndEmploymentService.saveEducationAndEmployment(
			educationAndEmploymentCompositeDto
		);
	}

	@GetMapping(
		value = {
			"/searchParticipants/{referenceId}/{firstname}/{middleName}/{surname}/{dateOfBirth}/{maritalStatus}/{city}/{phoneNumber}"
		},
		produces = "application/json"
	)
	...
	public List<ParticipantSearchResultsDto> searchParticipants(
		...
		ParticipantSearchCriteriaDto participantSearchCriteriaDto = getParticipantSearchCriteriaDto(
			var
		);
	...
	private ParticipantSearchCriteriaDto getParticipantSearchCriteriaDto(
		...
		participantSearchCriteriaDto.setFirstname(
			("null".equals(var.get("firstname")) || var.get("firstname") == null)
				? null
				: var.get("firstname")
		);
		participantSearchCriteriaDto.setCity(
			("null".equals(var.get("city")) || var.get("city") == null) ? null : var.get("city")
		);
		participantSearchCriteriaDto.setDateOfBirth(dateTime);
		participantSearchCriteriaDto.setMaritalStatus(
			("null".equals(var.get("maritalStatus")) || var.get("maritalStatus") == null)
				? null
				: var.get("maritalStatus")
		);
		participantSearchCriteriaDto.setSurname(
			("null".equals(var.get("surname")) || var.get("surname") == null)
				? null
				: var.get("surname")
		);
		participantSearchCriteriaDto.setMiddleName(
			("null".equals(var.get("middleName")) || var.get("middleName") == null)
				? null
				: var.get("middleName")
		);
		participantSearchCriteriaDto.setPhoneNumber(
			("null".equals(var.get("phoneNumber")) || var.get("phoneNumber") == null)
				? null
				: var.get("phoneNumber")
		);

		participantSearchCriteriaDto.setReferenceId(
	...
	@GetMapping(
		value = "/readAllOutputParticipant/{referenceId}",
		produces = "application/json"
	)
	@ApiOperation("Read All Output Participant")
	@ResponseStatus(HttpStatus.OK)
	public ParticipantCommonDataDto readAllOutPutParticipant(
	...
	@GetMapping(
		value = "/readParticipantReminder/{participantReminderId}",
		produces = "application/json"
	)
	@ApiOperation("Read Participant Reminder By Id")
	@ResponseStatus(HttpStatus.OK)
	public ParticipantReminderDto readParticipantReminder(
		@PathVariable("participantReminderId") Long participantReminderId
	) {
	...
	@GetMapping(
		value = { "/searchParticipantReminder/{participantId}/{data}" },
		produces = "application/json"
	)
	@ApiOperation("Search ParticipantReminder")
	@ResponseStatus(HttpStatus.OK)
	public List<ParticipantReminderSearchResultsDto> searchParticipantReminder(
		@PathVariable Map<String, String> var
	) {
		ParticipantReminderSearchCriteriaDto participantReminderSearchCriteriaDto = new ParticipantReminderSearchCriteriaDto();

		participantReminderSearchCriteriaDto.setParticipantId(
			("null".equals(var.get("participantId")) || var.get("participantId") == null)
				? null
				: Long.parseLong(var.get("participantId"))
		);
	...
	@ResponseStatus(HttpStatus.ACCEPTED)
	public void removeParticipantReminder(
		@PathVariable("participantReminderId") Long participantReminderId
	) {
	...
	private void mapParticipantFormData(
		...
		participantIdentityDto.setRemoveProfilePicture(
			new Boolean(params.get("removeProfilePicture"))
		);
	...
	public List<ParticipantAppointmentDto> saveParticipantAppointment(
		...
		return participantAppointmentService.saveParticipantAppointment(
	...
	@ApiOperation("Remove Counselor CFS Workers")
	@ResponseStatus(HttpStatus.ACCEPTED)
	public void removeParticipantAppointment(
	...
	@GetMapping(
		value = { "/searchParticipantAppointent/{participantid}/{data}" },
		produces = "application/json"
	)
	...
	public List<ParticipantAppointmentSearchResultsDto> searchParticipantAppointment(
		...
		participantAppointmentSearchCriteriaDto.setParticipantId(
			("null".equals(var.get("participantid")) || var.get("participantid") == null)
				? null
				: Long.parseLong(var.get("participantid"))
		);
		...
		return participantContactNotesSearchService.search(
			participantAppointmentSearchCriteriaDto
		);
	}

	@GetMapping(
		value = "/readOneAppointment/{participantAppointmentId}",
		produces = "application/json"
	)
	...
	public ParticipantAppointmentDto readOneAppointment(
		...
		log.info(
			"ReadOneAppointment " + "ParticipantAppointmentId :" + participantAppointmentId
		);
