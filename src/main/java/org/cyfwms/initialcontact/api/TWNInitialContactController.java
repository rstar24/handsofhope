...
public class TWNInitialContactController {
	...
	@GetMapping(
		value = "/readAllFileDetails/{filedetailsid}",
		produces = "application/json"
	)
	@ApiOperation("Read Identity")
	@ResponseStatus(HttpStatus.OK)
	public ICFileDetailsDto readAllFileDetails(
		@PathVariable("filedetailsid") Long fileDetailsID
	) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ICFileDetailsDto> saveAllFileDetails(
		@RequestBody ICFileDetailsDto iCFileDetailsDto
	) {
		ICFileDetailsDto icFileDetailsDto = iCFileDetailsService.saveAllFileDetails(
			iCFileDetailsDto
		);
	...
	@GetMapping(
		value = "/readAllIncidentReports/{filedetailsid}",
		produces = "application/json"
	)
	@ApiOperation("Read IncidentReports")
	@ResponseStatus(HttpStatus.OK)
	public ICIncidentReportDto readAllIncidentReports(
		@PathVariable("filedetailsid") Long fileDetailsID
	) {
	...
	public ResponseEntity<ICIncidentReportDto> saveAllIncidentReports(
		...
		iCIncidentReportDto =
			iCIncidentReportService.saveAllIncidentReports(iCIncidentReportDto);
		log.info("SaveAllIncidentReports " + iCIncidentReportDto);
		return new ResponseEntity<>(iCIncidentReportDto, HttpStatus.CREATED);
	}

	@GetMapping(
		value = "/readAllPatientCareInfo/{filedetailsid}",
		produces = "application/json"
	)
	@ApiOperation("Read PatientCareInfo")
	@ResponseStatus(HttpStatus.OK)
	public ICPatientCareInfoDto readAllPatientCareInfo(
		@PathVariable("filedetailsid") Long fileDetailsID
	) {
	...
	public ResponseEntity<ICPatientCareInfoDto> saveAllPatientCareInfo(
		...
		iCPatientCareInfoDto =
			iCPatientCareInfoService.saveAllPatientCareInfo(iCPatientCareInfoDto);
		log.info("SaveAllPatientCareInfo " + iCPatientCareInfoDto);
		return new ResponseEntity<>(iCPatientCareInfoDto, HttpStatus.CREATED);
	}

	@GetMapping(
		value = "/readAllPresentConcerns/{filedetailsid}",
		produces = "application/json"
	)
	@ApiOperation("Read PresentConcerns")
	@ResponseStatus(HttpStatus.OK)
	public ICPresentConcernsDto readPresentConcerns(
		@PathVariable("filedetailsid") Long fileDetailsID
	) {
	...
	public ResponseEntity<ICPresentConcernsDto> savePresentConcerns(
		...
		iCPresentConcernsDto =
			iCPresentConcernsService.savePresentConcerns(iCPresentConcernsDto);
		log.info("SaveAllPresentConcerns " + iCPresentConcernsDto);
		return new ResponseEntity<>(iCPresentConcernsDto, HttpStatus.CREATED);
	}

	@GetMapping(
		value = "/readAllReferralInfo/{filedetailsid}",
		produces = "application/json"
	)
	@ApiOperation("Read ReferralInfo")
	@ResponseStatus(HttpStatus.OK)
	public ICReferralInfoDto readAllReferralInfo(
		@PathVariable("filedetailsid") Long fileDetailsID
	) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ICReferralInfoDto> saveAllReferralInfo(
		@RequestBody ICReferralInfoDto iCReferralInfoDto
	) {
	...
	@GetMapping(
		value = "/readAllContactNotes/{contactnotesid}",
		produces = "application/json"
	)
	@ApiOperation("Read ContactNotes")
	@ResponseStatus(HttpStatus.OK)
	public ICContactNotesDto readContactNotes(
		@PathVariable("contactnotesid") Long contactNotesId
	) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ICContactNotesDto> saveContactNotes(
		@RequestBody ICContactNotesDto iCContactNotesDto
	) {
	...
	@GetMapping(
		value = { "/searchContactNotes/{filedetailsid}/{data}" },
		produces = "application/json"
	)
	@ApiOperation("Search InitialContact")
	@ResponseStatus(HttpStatus.OK)
	public List<ICContactNotesSearchResultsDto> searchICContactNotes(
		...
		iCContactNotesSearchCriteriaDto.setFileDetailsId(
			("null".equals(var.get("filedetailsid")) || var.get("filedetailsid") == null)
				? null
				: Long.parseLong(var.get("filedetailsid"))
		);
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<String> removeContactNotes(
		@PathVariable("contactNotesId") Long contactNotesId
	) {
	...
	@GetMapping(
		value = "/readICParticipant/{icparticipantid}",
		produces = "application/json"
	)
	@ApiOperation("Read ICParticipant")
	@ResponseStatus(HttpStatus.OK)
	public ICParticipantDto readICParticipant(
		@PathVariable("icparticipantid") Long icParticipantId
	) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ICParticipantDto saveICParticipant(
		@RequestBody ICParticipantDto iCParticipantDto
	) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<String> removeICParticipant(
		@PathVariable("icparticipantid") Long icParticipantId
	) {
	...
	@DeleteMapping(
		value = "/removeICReminder/{icReminderId}",
		produces = "application/json"
	)
	@ApiOperation("Remove ICReminder by icReminderId")
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<String> removeICReminder(
		@PathVariable("icReminderId") Long icReminderId
	) {
	...
	@GetMapping(
		value = { "/searchICReminder/{fileDetailsId}/{data}" },
		produces = "application/json"
	)
	...
	public List<ICSearchReminderResultDto> searchICReminder(
		...
		iCSearchReminderDto.setFileDetailsId(
			("null".equals(var.get("fileDetailsId")) || var.get("fileDetailsId") == null)
				? null
				: Long.parseLong(var.get("fileDetailsId"))
		);
	...
	@GetMapping(
		value = { "/participantICSearch/{filedetailsid}/{data}" },
		produces = "application/json"
	)
	...
	public List<ICParticipantSearchResultDto> searchICParticipant(
		...
		iCParticipantSearchCriteriaDto.setFileDetailsId(
			("null".equals(var.get("filedetailsid")) || var.get("filedetailsid") == null)
				? null
				: Long.parseLong(var.get("filedetailsid"))
		);
	...
	public List<ICAppointmentDto> saveParticipantAppointment(
		@RequestBody ICAppointmentDto icAppointmentDto
	) {
	...
	public void removeParticipantAppointment(
		@PathVariable("ICAppointmentId") Long ICAppointmentId
	) {
	...
	@GetMapping(
		value = "/readOneAppointment/{ICAppointmentId}",
		produces = "application/json"
	)
	@ApiOperation("Read ContactNotes")
	@ResponseStatus(HttpStatus.OK)
	public ICAppointmentDto readOneAppointment(
		@PathVariable("ICAppointmentId") Long ICAppointmentId
	) {
	...
	@GetMapping(
		value = { "/searchICAppointment/{fileDetailsId}/{data}" },
		produces = "application/json"
	)
	...
	public List<ICAppointmentSearchResultDto> searchICAppointment(
		...
		icAppointmentSearchDto.setFileDetailsId(
			("null".equals(var.get("fileDetailsId")) || var.get("fileDetailsId") == null)
				? null
				: Long.parseLong(var.get("fileDetailsId"))
		);
