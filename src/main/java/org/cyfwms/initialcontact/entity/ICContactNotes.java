...
public class ICContactNotes implements Serializable {
	...
	@Getter
	@Setter
	@Column(length = 1000, name = "needaddress")
	...
	@Getter
	@Setter
	@Column(length = 1000, name = "result")
	private String result;

	@Getter
	@Setter
	@Column(length = 1000, name = "nextstep")
	private String nextStep;

	@Getter
	@Setter
	@Column(length = 1000, name = "caseplanprogress")
	private String casePlanProgress;

	@Getter
	@Setter
	@Column(length = 1000, name = "additionalinformation")
