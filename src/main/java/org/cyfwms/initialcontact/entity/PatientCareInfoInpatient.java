...
public class PatientCareInfoInpatient {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "inpatientidgenerator")
	private Long inpatientId;

	@Getter
	@Setter
	@Column(name = "hospitalizationrecord")
	private String hospitalizationRecord;

	@Getter
	@Setter
	@Column(length = 1000, name = "hospitalizationreasons")
