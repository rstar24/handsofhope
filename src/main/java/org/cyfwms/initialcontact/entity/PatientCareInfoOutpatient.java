...
public class PatientCareInfoOutpatient {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "outpatientidgenerator")
	private Long outpatientId;

	@Getter
	@Setter
	@Column(length = 1000, name = "therapyorcounseling")
	...
	@Getter
	@Setter
	@Column(length = 1000, name = "reasonfortherapy")
