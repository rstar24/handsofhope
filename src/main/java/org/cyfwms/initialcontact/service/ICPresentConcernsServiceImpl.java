...
public class ICPresentConcernsServiceImpl implements ICPresentConcernsService {
	...
	@Override
	public ICPresentConcernsDto savePresentConcerns(
		ICPresentConcernsDto iCPresentConcernsDto
	) {
		...
		if (iCPresentConcernsDto.getPresentConcernsId() == 0) {
			...
			iCPresentConcerns =
				iCPresentConcernsRepository
					.findById(iCPresentConcernsDto.getPresentConcernsId())
					.get();
			BeanUtils.copyProperties(iCPresentConcernsDto, iCPresentConcerns);
		}
