...
public class CommonApi {
	...
	@GetMapping(
		value = "/appointment/getAllCalenderDate/{date}",
		produces = "application/json"
	)
	@ApiOperation("Calender Api Of Appointment")
	@ResponseStatus(HttpStatus.OK)
	public List<CalenderAppointmentDto> getAllCommonCalenderDate(
	...
	@GetMapping(
		value = "/reminder/getAllCalenderDate/{date}",
		produces = "application/json"
	)
	@ApiOperation("Calender Api Of Reminder")
	@ResponseStatus(HttpStatus.OK)
	public List<CalenderReminderDto> getAllReminderCalenderDate(
		@PathVariable("date") String date
	) {
		LocalDate dateTime = null;
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
